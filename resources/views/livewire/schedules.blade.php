        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[200px]">Actions</th>
                </tr>
            </thead>
                    ...
                    <td class="px-6 py-4 text-sm font-medium">
                        <div class="flex flex-wrap gap-2 items-center">
                            ...
                            <button wire:click="toggleActive({{ $schedule->id }})" 
                                    class="inline-flex items-center px-3 py-1.5 bg-yellow-50 text-yellow-700 text-xs font-medium rounded-md hover:bg-yellow-100 transition-colors whitespace-nowrap">
